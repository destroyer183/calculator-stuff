...
# maybe separate this into 3 files, quadratic, trigonometry, and factoring
...
# factor equations, i.e. simple trinomials, complex trinomials, perfect square trinomials, difference of square trinomials,
